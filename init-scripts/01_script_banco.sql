...
CREATE OR REPLACE VIEW `vw_processos_consumidores` AS
 ...
 SELECT * FROM vw_processos_consumidores WHERE fk_servidor = 3 LIMIT 10;

INSERT INTO `processo` VALUES
 (NULL, 1805, 'java', 13.6, 23.6, 20.3, 0.0, now(), 1),
 (NULL, 1311, 'code', 28.9, 35.1, 21.5, 0.0, now(), 2),
 (NULL, 2307, 'firefox', 20.0, 21.3, 22.5, 0.0, now(), 3);
